...
function showRequest(formData, jqForm, options) {
	...
	if(form.name<?php ($key!='') ? print '_'.$key : print '' ?>Admincp.value == '' || form.category_idAdmincp.value==''){
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade <?=$flag == false ? 'active in' : ''; $flag = true; ?>" id="<?=$value?>">
								<div class="form-group last">
									<label class="control-label col-md-3">Value<?php ($key!='') ? print ' ('.mb_strtoupper($key).')' : print '' ?> <span class="required" aria-required="true">*</span></label>
