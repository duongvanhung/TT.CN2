							...
							<table class="table table-striped table-bordered table-hover dataTable no-footer">
								<thead>
									...
									<tr role="row">
										...
										<th class="center sorting" onclick="sort('name')" id="function" width="150">Contents</th>
										<th class="center sorting" onclick="sort('status')" width="150">Status</th>
										<!-- <th class="center" width="150">Username</th> -->
										<!-- <th class="center" width="150">Coutry</th> -->
