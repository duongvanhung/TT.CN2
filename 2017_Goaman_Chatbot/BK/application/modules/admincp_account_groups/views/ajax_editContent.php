							...
							<div class="col-md-9">
								<div class="gr_perm">
									...
									<div class="content_perm">
										...
										<div class="gr_item_perm">
											<div class="item_perm_chk"><input <?php if(isset($result->permission)){ if(substr($result->permission,5,1)=='a'){ print 'checked="checked"'; }} ?> class="perm_access0" type="checkbox" onClick="chk_perm(0,'approve')" name="approve0Admincp" id="approve0" /></div>
											<div class="item_perm_label">Approve</div>
										</div>
									</div>
								</div>
								...
								<div class="gr_perm">
									...
									<div class="content_perm">
										...
										<div class="gr_item_perm">
											<div class="item_perm_chk"><input <?php if(isset($result->permission)){ if(substr($result->permission,$pos+5,1)=='a'){ print 'checked="checked"'; }} ?> type="checkbox" onClick="chk_perm(<?=$v->id?>,'approve')" class="perm_access<?=$v->id?>" name="approve<?=$v->id?>Admincp" id="approve<?=$v->id?>" /></div>
											<div class="item_perm_label">Approve</div>
										</div>
									</div>
								</div>
