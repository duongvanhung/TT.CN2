...
<div class="gr_perm">
	...
	<div class="content_perm">
		...
		<div class="gr_item_perm">
			<div class="item_perm_chk"><input <?php if(isset($result->permission)){ if(substr($result->permission,$pos+5,1)=='a'){ print 'checked="checked"'; }} ?> type="checkbox" onClick="chk_perm(<?=$v->id?>,'approve')" class="custom_chk perm_access<?=$v->id?>" name="approve<?=$v->id?>Admincp" id="approve<?=$v->id?>" /></div>
