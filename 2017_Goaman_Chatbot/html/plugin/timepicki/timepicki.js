	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prev-timepicki action-prev'></div>" :
				"<div class='prev-timepicki action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='next-timepicki action-next'></div>" :
				"<div class='next-timepicki action-prev'></div>";
			...
			inputs.on('keydown', function(e) {
				...
				if (e.which === 38) {
					if (settings.increase_direction === 'down') {
						direction = 'prev-timepicki';
					} else {
						direction = 'next-timepicki';
					}
				// DOWN
				} else if (e.which === 40) {
					if (settings.increase_direction === 'down') {
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'next-timepicki') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prev')) || direction === 'prev-timepicki') {
				...
				if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'next-timepicki') {
					if (cur_mins + step_size > ele_en) {
						...
						if(settings.overflow_minutes){
							change_time(null, 'next-timepicki');
						}
					} else {
					...
					if (cur_mins - step_size <= -1) {
						...
						if(settings.overflow_minutes){
							change_time(null, 'prev-timepicki');
						}
					} else {
						cur_mins = cur_mins - step_size;
						if (cur_mins < 10) {
