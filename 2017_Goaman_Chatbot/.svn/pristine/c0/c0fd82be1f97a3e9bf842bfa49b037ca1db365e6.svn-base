...
<head>
<meta charset="utf-8"/>
<title>Landing Page Builder | Admin Control Panel</title>
...
<script src="<?=PATH_URL.'assets/js/'?>jquery-1.12.4.min.js" type="text/javascript"></script>
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo">
			<a class="txt-logo" href="<?=PATH_URL_ADMIN?>">GoAman</a>
		</div>
		<!-- END LOGO -->
...
<div class="page-footer">
	<div class="page-footer-inner">
		&copy; 2015 GoAman. All rights reserved.
	</div>
